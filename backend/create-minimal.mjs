...
async function createMinimalCollections() {
  try {
    ...
    // Create recipes collection (no problematic fields)
    ...
    // Create sessions collection (with simpler status field)
    ...
    console.log('🎉 All collections working! UI should work at: http://localhost:5173/');
